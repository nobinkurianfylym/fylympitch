...
export default async function ProfilePage() {
  ...
  return (
    <div>
      ...
      {/* ── DIVIDER ── */}
      <div className="hairline-gold mt-16 pt-12">
        <h2 className="font-display text-[28px] mb-1">Credits &amp; Track Record</h2>
        <p className="text-[14px] text-ash max-w-lg mb-10">
