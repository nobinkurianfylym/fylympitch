    ...
    <div className="min-h-screen bg-ivory">
      ...
      <main className="max-w-[1100px] mx-auto px-6 pt-12 pb-24">
        ...
        <div className="mb-10 px-5 py-4 rounded-card border-2 border-amber-400 bg-amber-50/80 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-[12px] text-amber-700 mt-1 leading-relaxed">
              Delete <code className="bg-amber-100 px-1.5 py-0.5 rounded font-mono text-[11px]">/app/dev-login/</code> before going live.
              Never deploy this page to production.
            </p>
          </div>
        </div>
        ...
        <div className="grid sm:grid-cols-3 gap-5 mb-8">
          {ACCOUNTS.map((account) => (
            <div
              ...
              style={{
                borderColor: account.accentBorder,
                background:  account.accentBg,
              }}
            >
              {/* Card header */}
              <div
                className="px-6 pt-6 pb-5 border-b"
                style={{ borderColor: account.accentBorder }}
              >
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span
                    className={`text-[10px] tracking-[0.16em] uppercase px-2.5 py-1 rounded-full border ${account.badgeClass}`}
                  >
                    {account.role}
                  </span>
                </div>
                <h2
                  className="font-display text-[24px] font-[400] leading-tight mb-1"
                >
                  {account.role}
                </h2>
              ...
              <div className="px-6 py-4 flex-1">
                <p className="text-[10px] tracking-[0.18em] uppercase text-ash mb-3">
                  Access
                </p>
              ...
              <div
                ...
                style={{ borderColor: account.accentBorder }}
              >
                <p className="text-[11px] text-ash mb-3 font-mono truncate">
                  {account.email}
                </p>
                <button
        ...
        <div className="mt-8 px-5 py-4 rounded-card border border-line bg-white/60">
          <p className="text-[11px] tracking-[0.16em] uppercase text-ash mb-3">
            First-time setup
          </p>
