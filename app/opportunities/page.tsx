    ...
    <div className="min-h-screen bg-ivory">
      ...
      <header className="border-b border-line">
        ...
        <nav className="md:hidden max-w-[1180px] mx-auto px-6 pb-3 flex items-center gap-8 text-[12px] tracking-[0.18em] uppercase text-ash">
          <Link href="/filmprojects" className="py-2.5 hover:text-ink transition-colors">Film Projects</Link>
          <Link href="/opportunities" className="py-2.5 text-ink">Opportunities</Link>
        </nav>
      </header>
